...
import projectThree from '../../src/assets/project3.png'
import majonft from '../../src/assets/majonft.png'
import bitcoin from '../../src/assets/bitcoin.png'
import { Link } from 'react-router-dom'

function CoinProjectBoxThree() {
    return (

        <div className='bg-[#222531] relative  rounded-md border-[1px] border-gray-300'>
            <div className='relative'>
                <img src={projectThree} />
                <img src={majonft} className='w-[60px] absolute right-4 -bottom-8' />
            ...
            <div className='px-3 pt-2 pb-12 flex flex-col gap-1'>
                <h3 className='text-white font-bold text-sm'>BRC-20 DAO Project</h3>
                <span className='text-[#F38010] text-[10px]'>$Majo</span>
                <span className='text-[#9B9BB0] text-[10px]'>Majo is the currency of Brc-20 DAO, you can use it across BRC-20 DAO and BRC-20 infrastructures.</span>
...
export default CoinProjectBoxThree